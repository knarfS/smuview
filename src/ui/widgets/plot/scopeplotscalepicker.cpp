...
#include "scopeplotscalepicker.hpp"
...
ScopePlotScalePicker::ScopePlotScalePicker(ScopePlot *plot) :
	QObject(plot),
	plot_(plot),
...
bool ScopePlotScalePicker::eventFilter(QObject *object, QEvent *event)
{
...
QPointF ScopePlotScalePicker::get_wheel_pos(QWheelEvent *wheel_event)
{
