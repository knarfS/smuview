...
void SmuScriptView::setup_toolbar()
{
	...
	action_open_->setShortcut(QKeySequence(QKeySequence::Open));
	...
	action_save_->setShortcut(QKeySequence(QKeySequence::Save));
	...
	action_find_->setShortcut(QKeySequence(QKeySequence::Find));
